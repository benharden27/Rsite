...
```{r, eval = FALSE}
devtools::install_github("benharden27/seaprocess")
```
...
If you want to combine data from different years, here is a starting point. You probably want to give each data set you are using a cruise ID as a column using the mutate function.
