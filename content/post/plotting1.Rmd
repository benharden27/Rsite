...
# Introduction to Plotting in ggplot

Data for this exercise can be found [here](../../data_raw/S258_neuston.csv).

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE, cahce = TRUE, include = TRUE, message = FALSE, warning = FALSE)
```
...
As some of you have had issues installing the complete `tidyverse`, we'll also be able to do all the exercises contained here by just loading the following libraries:
...
![Visualization of how values are organized in a data frame (reproduced from R for Data Science)](/Users/benjamin/Documents/SEA/S285_OC/dcv/R/classes/tidy_1.png)
